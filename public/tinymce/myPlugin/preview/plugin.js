 ...
 (function () {
    ...
    var getPreviewHtml = function (editor,preContent) {
      var headHtml = '';
      ...
      var previewContent = preContent || editor.getContent()
      var previewHtml = '<!DOCTYPE html>' + '<html>' + '<head>' + headHtml + '</head>' + '<body id="' + encode(bodyId) + '" class="mce-content-body ' + encode(bodyClass) + '"' + dirAttr + '>' + previewContent + preventClicksOnLinksScript + '</body>' + '</html>';
      return previewHtml;
    };

    var open = function (editor,preContent) {
      var content = getPreviewHtml(editor,preContent);
    ...
    var register = function (editor) {
      editor.addCommand('mcePreview', function (preContent) {
        open(editor,preContent);
      });
    };
